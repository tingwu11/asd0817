//
//  4OpenMapDirections.swift
//  asd
//
//  Created by apple on 2021/8/26.
//
//仁人堂24.23975,120.56034

import CoreLocation
import MapKit
import UIKit

class OpenMapDirections4 {
    ...
    static func present(in viewController: UIViewController, sourceView: UIView) {
        ...
        actionSheet.addAction(UIAlertAction(title: "Google 地圖", style: .default, handler: { _ in
            ...
            let url = URL(string: "comgooglemaps://?daddr=24.23975,120.56034&directionsmode=driving&zoom=14&views=traffic")!
        ...
        actionSheet.addAction(UIAlertAction(title: "地圖", style: .default, handler: { _ in
            ...
            let coordinate = CLLocationCoordinate2DMake(24.23975,120.56034)
