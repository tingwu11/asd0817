//
//  7OpenMapDirections.swift
//  asd
//
//  Created by apple on 2021/8/26.
//
//楊耳鼻喉科24.23371,120.56247

import CoreLocation
import MapKit
import UIKit

class OpenMapDirections7 {
    ...
    static func present(in viewController: UIViewController, sourceView: UIView) {
        ...
        actionSheet.addAction(UIAlertAction(title: "Google 地圖", style: .default, handler: { _ in
            ...
            let url = URL(string: "comgooglemaps://?daddr=24.23371,120.56247&directionsmode=driving&zoom=14&views=traffic")!
        ...
        actionSheet.addAction(UIAlertAction(title: "地圖", style: .default, handler: { _ in
            ...
            let coordinate = CLLocationCoordinate2DMake(24.23371,120.56247)
