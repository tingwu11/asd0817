//
//  8OpenMapDirections.swift
//  asd
//
//  Created by apple on 2021/8/26.
//
//蕭英宗耳鼻喉科24.24061,120.56072

import CoreLocation
import MapKit
import UIKit

class OpenMapDirections8 {
    ...
    static func present(in viewController: UIViewController, sourceView: UIView) {
        ...
        actionSheet.addAction(UIAlertAction(title: "Google 地圖", style: .default, handler: { _ in
            ...
            let url = URL(string: "comgooglemaps://?daddr=24.24061,120.56072&directionsmode=driving&zoom=14&views=traffic")!
        ...
        actionSheet.addAction(UIAlertAction(title: "地圖", style: .default, handler: { _ in
            ...
            let coordinate = CLLocationCoordinate2DMake(24.24061,120.56072)
