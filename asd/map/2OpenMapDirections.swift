//
//  2OpenMapDirections.swift
//  asd
//
//  Created by apple on 2021/8/26.
//
//何秋燕皮膚科24.23243,120.55867

import CoreLocation
import MapKit
import UIKit

class OpenMapDirections2 {
    ...
    static func present(in viewController: UIViewController, sourceView: UIView) {
        ...
        actionSheet.addAction(UIAlertAction(title: "Google 地圖", style: .default, handler: { _ in
            ...
            let url = URL(string: "comgooglemaps://?daddr=24.23243,120.55867&directionsmode=driving&zoom=14&views=traffic")!
        ...
        actionSheet.addAction(UIAlertAction(title: "地圖", style: .default, handler: { _ in
            ...
            let coordinate = CLLocationCoordinate2DMake(24.23243,120.55867)
